...
@Component({
  selector: 'app-abmc-usuario',
  templateUrl: './abmc-usuario.component.html',
  styleUrls: ['./abmc-usuario.component.css']
})
export class AbmcUsuarioComponent implements OnInit{
  ...
  //listado de usuarios que se van a mostrar en la tabla
  tabla: Usuario[]=[];
  ...
  //para controlar que una vez que se obtengan los roles se establezcan los datos a editar o sino el rol no se mostrará
